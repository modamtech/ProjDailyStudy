...
function createTable(){
	db.transaction(function(tr){
		var createSQL = "create table if not exists tbl_toeic_test(no int, cntnt1 text, cntnt2 text, cntnt3 text, cntnt4 text, cntnt5 text, cntnt6 text, exmpla text,  exmplb text, exmplc text, exmpld text)";
